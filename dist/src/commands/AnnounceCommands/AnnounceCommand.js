    ...
    switch (args[0]) {
        ...
        case 'findme':
            if (isOwner()) {
                await announcementChannel.send('@everyone', client.emptyEmbed({
                    title: 'Virus Pattern!',
                    description: 'Seems like our researchers have found patterns on living bodies indicating the virus!\nQuickly proceed to the website and check on your tasks!\n\n看来有研究员发现了存活在生物上的病毒规律!\n赶快到网站检查你们的新任务吧!\n\n*Hint: Click the Title Text to navigate to website!*\n*温馨提示: 点击此标题以进入网站!*',
                    url: 'https://thecure-web.vercel.app/',
                }));
            }
            break;
